		...
		<nav class="navbar-default navbar-side" role="navigation">
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					<li><a href="/uploadSheet/uploadSheetList.do"><i class="glyphicon glyphicon-upload"></i>엑셀업로드</a></li>
					<li><a href="/ordersheet/ordersheetList.do"><i class="glyphicon glyphicon-download"></i>발주</a></li>
					<li><a href="/orderHistory/orderHistoryList.do"><i class="glyphicon glyphicon-list-alt"></i>발주이력</a></li>
...
$.each( $("#main-menu li a"), function() {
	if($(this).attr("href").match(/${menuUrl }/g)){
